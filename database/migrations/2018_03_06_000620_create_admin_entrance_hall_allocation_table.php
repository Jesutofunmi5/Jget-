...
class CreateAdminEntranceHallAllocationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('admin_entrance_hall_allocation', function (Blueprint $table) {
            $table->increments('id');
            $table->string('hall');
    ...
    {
        Schema::drop('admin_entrance_hall_allocation');
    }
}
